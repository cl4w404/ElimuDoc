...
class Kcse extends StatefulWidget {
  Kcse({Key? key, required this.category, required this.title})
      : super(key: key);
  String category;
  String title;

  @override
  _KcseState createState() => _KcseState();
}

class _KcseState extends State<Kcse> {
  String name = "";
